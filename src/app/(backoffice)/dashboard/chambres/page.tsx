            ...
            <tbody className="divide-y divide-gray-700">
              {chambres.map((c, index) => (
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <span className="text-sm text-gray-300">{c.hebergement}</span>
                  </td>
                  <td className="px-4 py-3">
                    <span className="text-sm text-gray-300">{c.typeChambre}</span>
                  </td>
                  <td className="px-4 py-3">
