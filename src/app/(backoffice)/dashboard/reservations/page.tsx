            ...
            <tbody className="divide-y divide-gray-700">
              {reservations.map((r, index) => (
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <span className="text-sm font-medium text-white">{r.utilisateur}</span>
                  </td>
                  <td className="px-4 py-3">
                    <span className="text-sm text-gray-300">{r.chambre}</span>
                  </td>
                  <td className="px-4 py-3">
                    <span className="text-xs text-gray-400">{r.dateDebut}</span>
                  </td>
                  <td className="px-4 py-3">
                    <span className="text-xs text-gray-400">{r.dateFin}</span>
                  </td>
                  <td className="px-4 py-3">
                    <span className="text-sm text-gray-300">{r.nombrePersonnes}</span>
                  </td>
                  <td className="px-4 py-3">
                    {r.statut === "Confirmée" ? (
