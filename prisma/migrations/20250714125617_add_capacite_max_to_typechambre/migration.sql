/*
  ...
  - Added the required column `capaciteMax` to the `TypeChambre` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `typechambre` ADD COLUMN `capaciteMax` INTEGER NOT NULL;
