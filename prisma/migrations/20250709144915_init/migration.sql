/*
  ...
  - You are about to drop the column `prixParNuit` on the `typechambre` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `typechambre` DROP COLUMN `prixParNuit`;

-- CreateTable
CREATE TABLE `TypeChambreHebergement` (
